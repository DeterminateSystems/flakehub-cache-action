...
jobs:
  check:
    ...
    steps:
      ...
      - uses: DeterminateSystems/flakehub-cache-action@v3 # or v3.19.1 to pin to a release
      - run: nix build .
```
...
📍 Pinning to `DeterminateSystems/flakehub-cache-action@v3.19.1` guarantees:
...
| `source-revision`           | The revision of `nix-magic-nix-cache` to use. Conflicts with all other `source-*` options.                                                                                                                                                                                                                                                                  |          | `f744b910cd69226888c61a3ddf933fdbe7286095` |
